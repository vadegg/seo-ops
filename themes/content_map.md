# Content map — topical authority plan

Pillars and their clusters. The Strategist picks a topic that
strengthens an under-built cluster; the Outliner lays in the
interlinking; the Publisher marks a subtopic `[x]` once covered.

Legend: `[ ]` open · `[x]` covered (≥1 published post)

## Pillar: UX Research Methods
